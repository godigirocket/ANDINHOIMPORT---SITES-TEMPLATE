        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-2">
              <a href={instagramUrl} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-3 h-9 rounded-lg transition-transform hover:-translate-y-0.5"
                style={{ color: '#fff', background: 'linear-gradient(135deg, #f09433, #e6683c, #dc2743, #bc1888)', border: '1px solid rgba(255,255,255,0.14)', boxShadow: '0 0 24px rgba(225,48,108,0.32)' }}>
              ...
              <a href={`${whatsappUrl}?text=${waMsg}`} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-3 h-9 rounded-lg transition-transform hover:-translate-y-0.5"
                style={{ color: '#06130b', background: 'linear-gradient(135deg, #25D366, #9AF7BD)', border: '1px solid rgba(255,255,255,0.14)', boxShadow: '0 0 24px rgba(37,211,102,0.28)' }}>
                <MessageCircle className="w-4 h-4 flex-shrink-0" />
                <span className="text-xs font-black text-[#06130b]">WhatsApp</span>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/50">
              ...
              <li className="flex items-center gap-2"><Phone className="w-3.5 h-3.5 flex-shrink-0" style={{ color: '#25D366' }} /><a href={`tel:${phone}`} className="hover-underline font-semibold transition-colors" style={{ color: '#25D366' }}>{phone}</a></li>
              ...
              <li className="pt-1">
                <PremiumButton href={`${whatsappUrl}?text=${waMsg}`} target="_blank" rel="noopener noreferrer"
                  variant="secondary" className="!text-[#25D366] text-xs px-4 py-2"
                  style={{ color: '#25D366', background: 'hsla(142,71%,45%,0.1)', borderColor: 'hsla(142,71%,45%,0.25)' }}>
